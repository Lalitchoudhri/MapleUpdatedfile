codeunit 50026 "WMS Process"
{
    ...
    begin
        WITH IntData DO BEGIN
            ...
            END
            ELSE
                ERROR(Text010, "Item No.", 'PO No.', "Document No.");
        END;
    end;
    ...
    begin
        WITH PL DO BEGIN
            CreateReservEntry.CreateReservEntryFor(DATABASE::"Purchase Line", "Document Type", "Document No.", '', 0, "Line No.", "Qty. per Unit of Measure", 0, 1, ReservationEntry);
            CreateReservEntry.CreateEntry("No.", "Variant Code", "Location Code", Description, "Expected Receipt Date", 0D, 0, 2);
        END;
    end;
    ...
    begin
        ...
        WITH PH DO BEGIN
            ...
            IF "Shortcut Dimension 1 Code" = '' THEN
                VALIDATE("Shortcut Dimension 1 Code", ShortDim1);
            IF "Shortcut Dimension 2 Code" = '' THEN
                VALIDATE("Shortcut Dimension 2 Code", ShortDim2);
            //Dimesion
    ...
    begin
        WITH IntData DO BEGIN
            IntegrationData.RESET;
            IntegrationData.SETRANGE(IntegrationData."Document Type", "Document Type");
            IntegrationData.SETRANGE(IntegrationData."Document No.", "Document No.");
    ...
    begin
        WITH IntData DO BEGIN
            ...
            IF TransferHeader.INSERT(TRUE) THEN BEGIN
                ...
                TransferHeader.VALIDATE("Transfer-from Code", "From Location");
                TransferHeader.VALIDATE("Transfer-to Code", "To Location");
                TransferHeader."Refreance No." := "Document No.";
    ...
    begin
        WITH IntData DO BEGIN
            ...
            TransferLine.VALIDATE("Transfer-from Code", "From Location");
            TransferLine.VALIDATE("Transfer-to Code", "To Location");
    ...
    begin
        WITH TL DO BEGIN
            CASE Direction OF
                Direction::Outbound:
                    BEGIN
                        CreateReservEntry.CreateReservEntryFor(DATABASE::"Transfer Line", 0, "Document No.", '', "Derived From Line No.", "Line No.", "Qty. per Unit of Measure", 0, 1, ReservationEntry);
                        ...
                        CreateReservEntry.CreateEntry("Item No.", "Variant Code", "Transfer-from Code", Description, 0D, "Shipment Date", 0, 2);

                        CreateReservEntry.CreateReservEntryFor(DATABASE::"Transfer Line", 0, "Document No.", '', "Derived From Line No.", "Line No.", "Qty. per Unit of Measure", 0, -1, ReservationEntry);
                        //CreateReservEntry.CreateReservEntryFor(DATABASE::"Transfer Line", 0, "Document No.", '', "Derived From Line No.", "Line No.", "Qty. per Unit of Measure", 0, -1, SerialNo, '');
                        CreateReservEntry.CreateEntry("Item No.", "Variant Code", "Transfer-to Code", Description, "Receipt Date", 0D, 0, 2);
                    END;
                Direction::Inbound:
                    BEGIN
                        CreateReservEntry.CreateReservEntryFor(DATABASE::"Transfer Line", 1, "Document No.", '', "Derived From Line No.", "Line No.", "Qty. per Unit of Measure", 0, 1, ReservationEntry);
    ...
    begin
        WITH TH DO BEGIN
            ...
            ReservationEntry.SETRANGE(ReservationEntry."Source ID", "No.");
            ReservationEntry.SETRANGE(ReservationEntry."Location Code", "Transfer-to Code");
    ...
    begin
        WITH IntData DO BEGIN
            ...
            END
            ELSE
                ERROR(Text010, "Item No.", 'Transfer Order', TH."No.");
        END;
    end;
    ...
    begin
        WITH ItemJnlLine DO BEGIN
            CreateReservEntry.CreateReservEntryFor(DATABASE::"Item Journal Line", "Entry Type", "Journal Template Name", "Journal Batch Name", 0, "Line No.", "Qty. per Unit of Measure", 0, 1, ReservationEntry);
            ...
            IF "Entry Type" = "Entry Type"::"Positive Adjmt." THEN
                CreateReservEntry.CreateEntry("Item No.", "Variant Code", "Location Code", Description, "Posting Date", 0D, 0, 3)
            ELSE
                IF "Entry Type" = "Entry Type"::"Negative Adjmt." THEN
                    CreateReservEntry.CreateEntry("Item No.", "Variant Code", "Location Code", Description, 0D, "Posting Date", 0, 3);
        END;

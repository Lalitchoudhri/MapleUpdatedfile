    ...
    begin
        ...
        if Irn1 <> '' then begin
            ...
            IF RecTSH1.FINDFIRST THEN BEGIN
                ;
                RecTSH1."IRN No." := Irn1;
                RecTSH1."Acknowledgement No." := AckNo1;
                EVALUATE(RecTSH1."Acknowledgement Date", CopyStr(AckDt1, 1, 10));
                //RecSIH1."Acknowledgement Date" := COPYSTR(AckDt, 1, 10);
                //QRMgmt.InitializeSignedQRCode(RecSIH1, SignedQRCode);
                ...
                QRGenerator.GenerateQRCodeImage(SignedQRCode1, TempBlob);
                FieldRef := recRef.Field(RecTSH1.FieldNo("QR Code"));//tk
                TempBlob.ToRecordRef(RecRef, RecTSH1.FieldNo("QR Code"));//tk
                recRef.Modify();
            END;
        end;
    end;
...
"message": "E-Way Bill is generated successfully"
        ...
        */
        ...
        if jtoken.AsValue().AsText() = 'Success' then begin
            ...
            transShipHeader."E-Way Bill No." := jtoken.AsValue().AsText();
            ...
            Message('Eway Bill Generated with No %1' + jtoken.AsValue().AsText(), transShipHeader."E-Way Bill No.");
        end
        else

page 50033 "Purchase Order Subform Buyback"
{
    ...
    layout
    {
        area(content)
        {
            repeater(Repeater)
            {
                ...
                field("Retail Buyback Ref. No."; "Retail Buyback Ref. No.")
                {
                    Visible = false;
                    ApplicationArea = All;
                }
                ...
                field("Direct Unit Cost"; "Direct Unit Cost")
                {
                    ...
                    begin
                        ...
                        END;
                        */
                        UpdateSalesOrderTotalAmt("Retail Buyback Ref. No.", "Direct Unit Cost", xRec."Direct Unit Cost");
                        IF GUIALLOWED THEN
                            WBU.RefreshPage();
    ...
    begin
        IF (Quantity <> 0) AND ItemExists("No.") THEN BEGIN
            UpdateSalesOrderTotalAmt("Retail Buyback Ref. No.", 0, "Direct Unit Cost");
            COMMIT;
    ...
    begin
        ...
        Type := Type::Item;
        "Retail Buyback Ref. No." := GetRetailSalesOrderNo(Rec);

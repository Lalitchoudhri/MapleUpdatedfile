pageextension 50096 "Item Tracking Lines" extends "Item Tracking Lines"
{
        ...
        addafter("New Serial No.")
        {
            ...
            field("MRP Value"; "MRP Value")
            {
                ...
                begin
                    ...
                    IF ("MRP Value" <> xRec."MRP Value") AND (xRec."MRP Value" <> 0) THEN BEGIN
                        CreateReservEntry.UpdReservEntryIMEI("Source Type", "Source Subtype", "Source ID", "Source Batch Name", "Source Prod. Order Line", "Source Ref. No.", "Qty. per Unit of Measure", "Serial No.", "Lot No.", "MRP Value");
                    END;
                    RecResEntry.Reset();
                    RecPl.Reset();
    ...
    begin
        ...
        FOR i := 1 TO QtyToCreate DO BEGIN
            ...
            VALIDATE("Serial No.", 'S' + "Item No." + itm."Last No. Used");

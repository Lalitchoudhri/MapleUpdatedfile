pageextension 50008 "Payment Methods" extends "Payment Methods"
{
    layout
    {
        ...
        {
            field("Service Charge Account No."; "Service Charge Account No.")
            {
                ApplicationArea = all;
            }
            field("Service Charge Perc"; "Service Charge Perc")
            {
                ApplicationArea = all;
            }
            ...
            field("Credit card Machine Code"; "Credit card Machine Code")
            {
    ...
    begin
        ...
        "Branch Code" := UserSetup."Location Code";
        //Updated WIN347--//WIN345--

pageextension 50120 "Location Card" extends "Location Card"
{
    layout
    {
        ...
        {
            field("Rental From Location"; "Rental From Location")
            {
                ApplicationArea = all;
            }
            ...
            field("E Com Location Code"; "E Com Location Code")
            {
                ApplicationArea = all;
            }
            ...
            field("POS Apple ID"; "POS Apple ID")
            {
                ApplicationArea = all;
            }
            field("Voucher Client ID"; "Voucher Client ID")
            {
                ApplicationArea = all;
            }
            field("Voucher Secret Code"; "Voucher Secret Code")
            {
                ApplicationArea = all;
            }
            field("Salable Location Code"; "Salable Location Code")
            {
                ApplicationArea = all;
            }
            field("Ingram Location"; "Ingram Location")
            {
                ApplicationArea = all;
            }
        }
        addbefore(Warehouse)
        {
            ...
            group(Communication)
            {
                ...
                field("Einvoice E-Mail"; "Einvoice E-Mail")
                {
            ...
            group("E-Invoice Credentisl")
            {
                ...
                field("E-Invoice User ID"; "E-Invoice User ID")
                {
                    ApplicationArea = all;
                }
                field("E-Invoice Password"; "E-Invoice Password")
                {
                    ApplicationArea = all;
                }
            }
    ...
    begin
        //KPPLDG00039
        IF "Location Type" = "Location Type"::"Pre-Booking" THEN
            TESTFIELD("Salable Location Code");
        //KPPLDG00039
    end;

        ...
        dataitem("Purch. Cr. Memo Hdr."; "Purch. Cr. Memo Hdr.")
        {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem("Purch. Cr. Memo Line"; "Purch. Cr. Memo Line")
                    {
                        ...
                        begin
                            ...
                            FinalTotal := "Purch. Cr. Memo Line"."Direct Unit Cost" * "Purch. Cr. Memo Line".Quantity + Abs(CGSTAmt) + Abs(SGSTAmt) + Abs(IGSTAmt);//Abs(recDetailedGSTLedgerEntry."GST Base Amount") + Abs(recDetailedGSTLedgerEntry."GST Amount");
            ...
            begin
                ...
                *//*
                ...
                // FinalTotal := "Purch. Cr. Memo Line"."Line Amount" + Abs(CGSTAmt) + Abs(SGSTAmt) + Abs(IGSTAmt);//Abs(recDetailedGSTLedgerEntry."GST Base Amount") + Abs(recDetailedGSTLedgerEntry."GST Amount");
                // ReportCheck1.InitTextVariable;
                // ReportCheck1.FormatNoText(AmountInWord, FinalTotal, ' ');

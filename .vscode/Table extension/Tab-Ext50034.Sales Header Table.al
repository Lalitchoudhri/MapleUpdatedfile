tableextension 50034 "Sales HeaderTable" extends "Sales Header"
{
    ...
    begin
        WITH SalesHeaderLocal DO BEGIN
            ...
            IF SalesLineLocal.FINDFIRST THEN BEGIN
                REPEAT
                    WITH SalesLineLocal DO BEGIN
                        ...
                        GenJnlLineLocal."Line No." := "Line No.";
                        GenJnlLineLocal."Posting Date" := SalesHeaderLocal."Document Date";
                        GenJnlLineLocal."Document Date" := SalesHeaderLocal."Document Date";
                        ;
                        GenJnlLineLocal."Shortcut Dimension 1 Code" := "Shortcut Dimension 1 Code";
                        GenJnlLineLocal."Shortcut Dimension 2 Code" := "Shortcut Dimension 2 Code";
                        GenJnlLineLocal."Dimension Set ID" := "Dimension Set ID";
                        GenJnlLineLocal."Account Type" := GenJnlLineLocal."Account Type"::"G/L Account";
                        VendorRec.GET("Scheme Vendor");
                        ...
                        GenJnlLineLocal."Document No." := NoSeriesMgt.GetNextNo(SalesSetup."Provisional Claim Nos", "Posting Date", TRUE);
                        GenJnlLineLocal."External Document No." := SalesInvoiceNo;
                        GenJnlLineLocal."Currency Code" := "Currency Code";
                        GenJnlLineLocal.Amount := "Scheme Amount";
                        GenJnlLineLocal."Scheme Code" := "Scheme Code";
                        GenJnlLineLocal."Scheme Amount" := "Scheme Amount";

table 50002 PDC
{
    ...
    begin
        ...
        WITH SalesHeader DO BEGIN
            ...
            SalesSetup.GET;
            // TestNoSeries;
            IF NoSeriesMgt.SelectSeries(SalesSetup."Posted Prepmt. Inv. Nos.", OldSalesHeader.RTGS_NO, RTGS_NO) THEN BEGIN
                NoSeriesMgt.SetSeries(RTGS_NO);
    ...
    begin
        WITH SalesHeader DO BEGIN
            ...
            SalesSetup.GET;
            // TestNoSeries;
            IF NoSeriesMgt.SelectSeries(SalesSetup."Posted Prepmt. Cr. Memo Nos.", OldSalesHeader.TRAN_NO, TRAN_NO) THEN BEGIN
                NoSeriesMgt.SetSeries(TRAN_NO);
